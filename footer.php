		...
		<div class="row">
			...
			<div class="col-sm">
				<div class="footer-widget mb-4">
					...
					<!-- widgets footer 3 end -->
					Association loi 1901 | <a href="<?php WP_SITEURL ?>/conditions-generales-de-vente/" class="link_white">CGV</a> | <a href="<?php WP_SITEURL ?>/conditions-generales-dutilisation/" class="link_white">CGU</a> |<br>
					<a href="<?php WP_SITEURL ?>/politique-de-confidentialite/" class="link_white">Politique de confidentialité</a><br>
